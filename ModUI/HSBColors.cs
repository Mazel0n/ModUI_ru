...
namespace ModUI.Internals
{
    ...
    internal struct HSBColor
    {
        ...
        {
            return HSBColor.ToColor(new HSBColor(Mathf.PingPong(Time.time * 1f, 1), 1, 1));
        }

        public static HSBColor RainbowHSB()
        {
            return new HSBColor(Mathf.PingPong(Time.time * 1f, 1), 1, 1);
        }
    }
}